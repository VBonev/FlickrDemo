...
/**
 * Created by vbonev on 2/28/2018.
 */

public class TwitterFeed extends TwitterResponseImpl implements Status, java.io.Serializable {
    ...
    /*package*/TwitterFeed(HttpResponse res, Configuration conf) throws TwitterException {
        super(res);
